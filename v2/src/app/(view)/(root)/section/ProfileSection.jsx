...
const ProfileSection = () => {
    ...
    const EducationBox = () =>{
        return(
            <div className=" space-y-3 bg-paragraph-default/10 lg:w-11/12 rounded-lg p-5">
                ...
                <h2 className=' capitalize text-paragraph-default text-sm flex gap-2 items-center'> <GoDotFill className=' text-primary-default'/> syed ammal engineering college</h2>
            </div>
        )
    }
    ...
    const ExperienceBox = () =>{
        return(
            <div className=" space-y-3 bg-paragraph-default/10 lg:w-11/12 rounded-lg p-5">
                ...
                <h2 className=' capitalize text-paragraph-default text-sm  flex gap-2 items-center'> <GoDotFill className=' text-primary-default'/> QTL agritech</h2>
            </div>
        )
    }
  ...
  return (
    <section className='py-12 lg:pt-16 lg:pb-16  overflow-x-hidden'>
        <div className="main rounded-xl p-8 space-y-8">
